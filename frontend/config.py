...
TEMPLATE_DESCRIPTIONS: Final[dict[str, str]] = {
    ...
    "README": (
        ...
        "an overview of the dataset's contents, organization, file structure, variables, "
        "metadata, data formats, processing methods, quality assurance procedures, access "
        "information, licensing, and citation guidance. Its purpose is to help users "
        "understand, navigate, and correctly interpret the data for analysis and research.\n"
        "\n"
        "You can use this README Generator tool to create a 'first pass' at your README "
        "document. This 'first pass' will attempt to fill in as many fields as possible "
        "using the information submitted by the user. This tool is designed to facilitate "
        "and improve the users experience creating a README document through prompted and "
        "structured AI integration.\n"
        "\n"
        "To get started, you will upload documentation related to your dataset. "
        "Examples of this include:\n"
        "- Publications explicitly discussing the model or dataset to be described by the README.\n"
        ...
        "\n"
        "*Note: This README Generator tool is a proof-of-concept application that utilizes "
