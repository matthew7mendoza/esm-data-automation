...
class TestDownloadFileNaming:
    ...
    def test_download_filename_custom_name_sanitized(self, mock_build: MagicMock, mock_st: MagicMock) -> None:
        mock_st.session_state = {
            "current_task_custom_name": "Project*#1/Cool"
        }
    ...
    @patch("frontend.app.st")
    @patch("frontend.app._build_final_document_string")
    def test_download_filename_fallback_to_template(self, mock_build: MagicMock, mock_st: MagicMock) -> None:
        mock_st.session_state = {
